class Admin::RoomsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @room.save
        format.html { redirect_to admin_hotel_rooms_path(@room), notice: 'Room was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @room.update(room_params)
        format.html { redirect_to admin_hotel_rooms_path(@room.hotel_id), notice: 'Room was successfully updated.' }
      else
